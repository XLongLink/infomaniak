...
[SDK Documentation](https://xlonglink.github.io/infomaniak/) &nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp; [Get the Token](https://manager.infomaniak.com/v3/infomaniak-api) &nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp; [API Reference](https://developer.infomaniak.com/docs/api)
